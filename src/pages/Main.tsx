      ...
      <main className="flex flex-col flex-grow items-center justify-center px-4">
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full bg-black/60 backdrop-blur-md border border-white/20 hover:bg-white/10 text-white font-medium py-6 px-8 rounded-2xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-terra-500"
          >
            Control
          </button>
